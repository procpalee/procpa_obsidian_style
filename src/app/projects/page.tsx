...
const OG = ogImageUrl({ kicker: 'PROCPA · PROJECTS', title: '프로젝트', subtitle: DESC })

export const metadata: Metadata = {
  title: '프로젝트',
  description: DESC,
  alternates: { canonical: '/projects' },
  openGraph: { title: '프로젝트', description: DESC, url: '/projects', images: [{ url: OG, width: 1200, height: 630 }] },
  twitter: { card: 'summary_large_image', title: '프로젝트', description: DESC, images: [OG] },
}
