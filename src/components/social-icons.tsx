...
export const socials: Social[] = [
  { label: 'Naver Blog', href: 'https://blog.naver.com/procpalee', icon: NaverIcon, handle: '@procpalee', featured: true },
  { label: 'YouTube', href: 'https://www.youtube.com/@Jaehyun-f9c', icon: YoutubeIcon, handle: '@Jaehyun', featured: true },
  { label: 'GitHub', href: 'https://github.com/procpalee', icon: GithubIcon, handle: 'procpalee', featured: true },
  { label: 'KakaoTalk', href: 'https://open.kakao.com/o/sQCXbyXg', icon: MessageCircle, handle: '오픈채팅', featured: true },
  { label: 'Email', href: 'mailto:wogus3575@naver.com', icon: Mail, handle: 'wogus3575@naver.com' },
]
