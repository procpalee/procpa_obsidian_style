...
export function SiteFooter() {
  return (
    <footer className="mt-16 border-t border-border/60">
      <div className="mx-auto flex max-w-[1200px] flex-col items-center gap-3 px-6 py-5 text-center text-[13px] text-muted-foreground md:h-14 md:flex-row md:justify-between md:py-0 md:text-left">
